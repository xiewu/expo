 ...
 */
//+ (nullable JavaScriptRuntime *)runtimeFromBridge:(nonnull RCTBridge *)bridge NS_SWIFT_NAME(runtime(fromBridge:));
...
// */
//+ (void)installSharedObjectClass:(nonnull JavaScriptRuntime *)runtime releaser:(void(^)(long))releaser;
//
///**
// Installs the EventEmitter class in the given runtime as `global.expo.EventEmitter`.
// */
//+ (void)installEventEmitterClass:(nonnull JavaScriptRuntime *)runtime;
//
///**
// Installs the NativeModule class in the given runtime as `global.expo.NativeModule`.
// */
//+ (void)installNativeModuleClass:(nonnull JavaScriptRuntime *)runtime;
