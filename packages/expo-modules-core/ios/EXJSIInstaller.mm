...
//+ (nonnull JavaScriptRuntime *)runtimeFromBridge:(nonnull RCTBridge *)bridge
//{
//  jsi::Runtime *jsiRuntime = reinterpret_cast<jsi::Runtime *>(bridge.runtime);
//  auto rt = std::shared_ptr<jsi::Runtime>(std::shared_ptr<jsi::Runtime>(), jsiRuntime);
//  auto rtn = ExpoModulesCoreJSI::JavaScriptRuntime::init(bridge.runtime, bridge.jsCallInvoker.get());
//  return rtn;
